...
export default function ServiceCardModal({ icon, title, description, onClose }: ServiceCardModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center px-2">
      <div className="relative bg-white rounded-[2.5rem] border-4 border-primary shadow-2xl w-[95vw] xl:w-[70vw] h-[calc(100vh-100px)] xl:h-[calc(100vh-180px)] flex flex-col xl:flex-row p-8 xl:p-20 fade-in-modal overflow-hidden">
        {/* Bouton fermer */}
        <button
