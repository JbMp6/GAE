...
export default function ActuCard({image,imageAlt,title,subtitle,description,href,onClick,}: ActuCardProps) {
  return (
    <div className="bg-white rounded-2xl overflow-hidden border border-primary hover:shadow-xl hover:scale-105 transition-all duration-300 w-[400px] h-[480px] flex flex-col">
      {/* Image Container */}
