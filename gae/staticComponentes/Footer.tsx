...
export default function Footer() {
  return (
    <footer className="w-full bg-[var(--color-secondary)] text-white py-12 px-4 xl:px-20 min-h-[calc(100vh-240px)] xl:min-h-0 z-25">
        <div className="w-full grid grid-cols-1 xl:grid-cols-3 gap-8 xl:gap-4">
          ...
          <div className="flex flex-col items-start xl:items-center">
            <div className="flex flex-col items-start">
                <h3 className="font-syntha text-lg xl:text-2xl mb-6">contact</h3>
